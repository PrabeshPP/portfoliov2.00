...
const Projects = () => {
  ...
  return (
    <section id='projects' className='min-h-[40vh] w-[100%] flex flex-col items-center'>
      ...
      <div className='min-h-[20vh] w-[95%] flex flex-wrap items-center sm:justify-start justify-center  mt-10 mb-5'>
          {
            ...
            projects.map((project)=>{
              return <a className='h-[60vh] sm:w-[30%] w-[80%] bg-white m-5 rounded-2xl shadow-md shadow-[#241f1f7b] hover:shadow-xl hover:shadow-[#241f1f7b]' href={project.projectLink} key={project.id} target="_blank">
