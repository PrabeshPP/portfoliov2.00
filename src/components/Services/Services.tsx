...
const Services = () => {
  ...
  return (
    <section id='services' className='min-h-[80vh] w-[100%] bg-[royalblue] flex flex-col justify-start items-center'>
      <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1440 320" className='sm:h-[35vh] h-[10vh] w-[100%]'>
        ...
        <h1 className='text-4xl font-bold sm:mt-0 mt-10 text-white'>Services</h1>
        <div className='min-h-[80vh] sm:w-[95%] sm:mt-10 mt-20 flex flex-wrap items-center justify-center'>
            {
                services.length===0?<div className='h-16 w-16 animate-spin bg-transparent rounded-full border-t-2 border-r-2 border-white'>
                  ...
                  return <div className='min-h-[50vh] sm:w-[33%] flex flex-col items-center transition-colors bg-white m-5 rounded-xl shadow-xl shadow-[#241f1f7b] cursor-pointer hover:shadow-2xl hover:shadow-[#000000b5] sm:hover:bg-[crimson] sm:hover:text-white' key={service.id}>
